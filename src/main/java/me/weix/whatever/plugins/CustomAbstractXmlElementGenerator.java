...
public class CustomAbstractXmlElementGenerator extends AbstractXmlElementGenerator {
	...
	public void addElements(XmlElement parentElement) {
		...
		addXmlSelectByCondition(parentElement);
...
//		addXmlLogicDeleteByIds(parentElement);
	...
	private void addXmlSelectByCondition(XmlElement parentElement) {
		// 增加find
		...
		sb.setLength(0);
		sb.append("select ");
		find.addElement(new TextElement(sb.toString()));
		find.addElement(getBaseColumnListElement());
